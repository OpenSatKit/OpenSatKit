...
struct {
    real e_1[2];
    } parmb_86 = { 980.665f, 6356.77f };

struct {
    real e_1[64];
    } lower5_ = { 1041.3f, 386.f, 190.f, 16.6728f, 115.f, 120.f, 94.5537f, 
...
struct {
    real e_1[1400];
    } parm5_ = { .99604f, .0385528f, .00303445f, -.105531f, -.00607134f, 
...
/*       TOTAL MASS DENSITY */
    ...
    goto L90;
L50:
    ddum = denss_(alt, &c_b43, &tinf, &gts3c_1.tlb, &c_b9, &c_b9, &t[2], &
	    lower5_1.ptm[5], &gts3c_1.s, &gts3c_1.t0, &gts3c_1.za, &
	    gts3c_1.z0, &tr12);
    goto L90;
L90:
...
/*        SET SWITCHES */
	...
	sav[i__ - 1] = sv[i__];
	csw_1.sw[i__ - 1] = mod(sv[i__], c_b79);
