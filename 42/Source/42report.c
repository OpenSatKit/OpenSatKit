...
void Report(void)
{
      ...
      static FILE *CssAmpsFile,*TwhlcmdFile;
      ...
      if (First) {
         ...
         CssAmpsFile = FileOpen(InOutPath,"CssAmps.42","w");
         TwhlcmdFile = FileOpen(InOutPath,"Twhlcmd.42","w");
      }
      ...
      if (OutFlag) {
         ...
         if (SC[0].Exists) {
            ...
            fprintf(CssAmpsFile,"%lf %lf %lf %lf\n",
               SC[0].FSW.Css[0].Amps,SC[0].FSW.Css[1].Amps,
               SC[0].FSW.Css[2].Amps,SC[0].FSW.Css[3].Amps);
            fprintf(TwhlcmdFile,"%lf %lf %lf\n",
               SC[0].FSW.Twhlcmd[0],SC[0].FSW.Twhlcmd[1],
               SC[0].FSW.Twhlcmd[2]);
         }
