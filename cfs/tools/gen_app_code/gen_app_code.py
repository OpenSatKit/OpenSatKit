...
#   06/29/16 | Jose F Martinez | Added script to create CMakeLists.txt for cmake build
#========================================================================================

import os, sys, app_utils, app_code_configs, app_code_builds, app_code_incs
import app_code_src, app_code_tables, app_code_tests, app_code_readme, app_code_cmake
...
for itm in g_Apps:
    ...
    print ""
    # Generate the app's CMakeLists.txt file used by CMake
    app_code_cmake.generate_cmakelists(itm)
    print ""
