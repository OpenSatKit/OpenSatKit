...
#   06/29/16 | Jose F Martinez | Modified app so that it can be used with sch_lab provided
#                                by open-source cfe. Needed to make it work out-of-the-box
#========================================================================================
...
#ifndef %s_WAKEUP_TIMEOUT     
#define %s_WAKEUP_TIMEOUT       500
#endif
...
int32 %s_InitData()
{
    ...
    /* Init wakeup count */
    g_%s_AppData.uiWakeupTimeout = %s_WAKEUP_TIMEOUT;
...
void %s_AppMain()
{
    ...
    {
        %s_RcvMsg(g_%s_AppData.uiWakeupTimeout);""" \
