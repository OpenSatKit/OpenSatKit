...
#define TFTP_APP_INIT_APP_INFO_EID   (TFTP_APP_BASE_EID + 0)
#define TFTP_APP_NOOP_INFO_EID       (TFTP_APP_BASE_EID + 1)
#define TFTP_APP_EXIT_ERR_EID        (TFTP_APP_BASE_EID + 2)
#define TFTP_APP_INVALID_MID_ERR_EID (TFTP_APP_BASE_EID + 3)

#define TFTP_APP_TOTAL_EID  4
