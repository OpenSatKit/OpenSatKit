/*
** Purpose: Implement CubeSat Controller Table.
**
** Notes:
**   None
**
...
**    2. The objct name must be identical (case sensitive) to the name in the
**       JSON file. 
**
*/
...
**
** Paramters used to compute the PD controller gains.
**
** Notes:
**   1. This must have the same function signature as JSON_ContainerFuncPtr.
*/
