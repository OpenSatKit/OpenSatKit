...
/**********************************************************************/
int ReadFromSocket(SOCKET Socket, struct AcType *AC) /* ~osk~ Added return value */
{
      ...
      if (NumBytes <= 0) return NumBytes; /* ~osk~ Added return value */
   ...
   return NumBytes; /* ~osk~ Added return value */
}
