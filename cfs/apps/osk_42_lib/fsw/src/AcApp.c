...
#ifdef _AC_STANDALONE_  /* ~osk~ I42 will call sensor processing functions */
/* .. Sensor Processing */
      GyroProcessing(AC);
...
#ifdef _AC_STANDALONE_  /* ~osk~ I42 will call actuator processing */
/* .. Actuator Processing */
      WheelProcessing(AC);
      MtbProcessing(AC);
#endif  /* ~osk~ End OSK exclusion */   
