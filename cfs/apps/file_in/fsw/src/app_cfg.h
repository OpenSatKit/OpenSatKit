/*
** Purpose: Define configurations for the File Input
**          application
**
** Notes:
...
#include "file_in_platform_cfg.h"
#include "osk_c_fw.h"
...
#define  FILE_IN_MAJOR_VER   1
#define  FILE_IN_MINOR_VER   0
...
#define FILE_IN_APP_BASE_EID  (OSK_C_FW_APP_BASE_EID +  0)
