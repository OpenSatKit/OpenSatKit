...
#define UPLINK_SB_SEND_ERR_EID                  (UPLINK_BASE_EID +  3)
#define UPLINK_CONFIG_MSG_TUNNEL_ENA_INFO_EID   (UPLINK_BASE_EID +  4)
#define UPLINK_CONFIG_MSG_TUNNEL_DIS_INFO_EID   (UPLINK_BASE_EID +  5)
#define UPLINK_CONFIG_MSG_TUNNEL_INDEX_ERR_EID  (UPLINK_BASE_EID +  6)
#define UPLINK_DESTRUCTOR_INFO_EID              (UPLINK_BASE_EID +  7) 
#define UPLINK_DEBUG_EID                        (UPLINK_BASE_EID +  8)
