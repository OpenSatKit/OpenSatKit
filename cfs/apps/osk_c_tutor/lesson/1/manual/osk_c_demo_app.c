/* LESSON 1 - Manual Updates
**
** Replace the entire contents of the current osk_c_tutor/fsw/src/osk_c_demo_app.c
...
static void SendHousekeepingPkt(void)
{
   ...
   */
   ...
   OskCDemo.HkPkt.MsgLogCnt    = 0;
   
   strncpy(OskCDemo.HkPkt.MsgLogFilename, "Later Lesson", OS_MAX_PATH_LEN);
