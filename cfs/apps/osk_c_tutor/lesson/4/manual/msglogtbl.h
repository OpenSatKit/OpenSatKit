...
**
** Replace the entire contents of the current osk_c_tutor/fsw/src/msglogtbl.h
...
typedef struct {
   ...
   /* Standard OSK table */
   const char*  AppName;
   boolean      Loaded;          /* Indicates whether the entire table been loaded */
   uint8        LastLoadStatus;
   uint16       LastLoadCnt;
   
   size_t    JsonObjCnt;
   CJSON_Obj JsonObj[MSGLOGTBL_JSON_MAX_OBJ];
