/************************************************************************
 ** File:
 **   $Id: cs_tablestbl.c 1.1.1.1 2015/03/03 11:58:38EST sstrege Exp  $
 **
 ...
 **
 ** Notes:
 **  This is a partially-populated table with valid entries.
 **  This table should be located in unit_test\cf\apps\CorrQQTable
 **
 ** $Log: cs_tablestbl.c  $
 ** Revision 1.1.1.1 2015/03/03 11:58:38EST sstrege 
 ** Added copyright information
 ** Revision 1.1 2011/09/06 15:22:40EDT jmdagost 
 ** Initial revision
 ** Member added to project c:/MKSDATA/MKS-REPOSITORY/CFS-REPOSITORY/cs/fsw/unit_test/cf/apps/CorrQQTable/project.pj
...
CS_Def_Tables_Table_Entry_t CS_TablesTable[CS_MAX_NUM_TABLES_TABLE_ENTRIES]= 
{
    ...
    /*   8 */ { CS_STATE_ENABLED,   "QQ.Table1"                },  /* Note QQ table registration changes in UT */
    /*   9 */ { CS_STATE_ENABLED,   "EE.Table1"                },
    /*  10 */ { CS_STATE_EMPTY,     ""                         },
    /*  11 */ { CS_STATE_EMPTY,     ""                         },
    /*  12 */ { CS_STATE_EMPTY,     ""                         },
    /*  13 */ { CS_STATE_EMPTY,     ""                         },
