...
#define KIT_SCH_INITSTATS_INF_EID       (KIT_SCH_BASE_EID + 0)
#define KIT_SCH_APP_EXIT_EID            (KIT_SCH_BASE_EID + 1)
#define KIT_SCH_APP_INVALID_MID_ERR_EID (KIT_SCH_BASE_EID + 2)
#define KIT_SCH_TOTAL_EID  1
