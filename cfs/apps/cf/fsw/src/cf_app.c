...
void CF_SendPDUToEngine(CFE_SB_MsgPtr_t MessagePtr)
{
    ...
    OS_printf("%02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X\n",
              ...
              PduDataPtr[8],PduDataPtr[9],PduDataPtr[10],PduDataPtr[11]);
 
    Uint16Ptr = (uint16 *)PduHdrPtr;
    OS_printf("%04X %04X %04X %04X %04X %04X\n",
              Uint16Ptr[0],Uint16Ptr[1],Uint16Ptr[2],
              Uint16Ptr[3],Uint16Ptr[4],Uint16Ptr[5]);
    }/* End cfdbg */           
#endif
