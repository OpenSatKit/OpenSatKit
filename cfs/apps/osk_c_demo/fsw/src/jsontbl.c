...
boolean JSONTBL_LoadCmd(TBLMGR_Tbl *Tbl, uint8 LoadType, const char* Filename)
{
   ...
   CFE_EVS_SendEvent(OSK_C_DEMO_INIT_DEBUG_EID, OSK_C_DEMO_INIT_EVS_TYPE, "JSONTBL_LoadCmd() Entry\n");
...
boolean EntryCallBack (int TokenIdx)
{
   ...
   if (EntryCnt == 4) {
      ...
      if (Index < JSONTBL_MAX_ENTRY_ID) {
         ...
         CFE_EVS_SendEvent(OSK_C_DEMO_INIT_DEBUG_EID, OSK_C_DEMO_INIT_EVS_TYPE, "JSONTBL-ParseLine: %d, %d, %d, %d\n",Index, Data1, Data2, Data3);
