...
{
    "OskCProto_ExCfeTbl", OSK_C_PROTO_APP_NAME "." OSK_C_PROTO_CFE_TBL_NAME, "Example cFE Table",
    OSK_C_PROTO_CFE_TBL_FILENAME, sizeof (ExTblData_Param)
};

ExTblData_Param OskCProto_ExCfeTbl = {{
   {  1,  2,  3},  //  0
   {  4,  5,  6},  //  1
   {  7,  8,  9},  //  2
   { 10, 11, 12},  //  3
