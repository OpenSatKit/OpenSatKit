...
#define EX_APP_OBJ_DEMO_CMD_DATA_LEN  (sizeof(ExAppObj_DemoCmdMsg) - CFE_SB_CMD_HDR_SIZE)
...
private:
   ...
   class DemoCmd : public oskfw::CmdMsg {
   public:
      DemoCmd(ExAppObj* ex_app_obj, uint16 data_len);
