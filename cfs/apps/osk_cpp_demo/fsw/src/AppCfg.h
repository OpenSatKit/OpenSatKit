...
struct AppCfg {
   ...
   static const int MINOR_VER  = 1;   /* Fixed cFE default table load issues */
   ...
   static const int OSK_CPP_DEMO_APP_BASE_EID  = oskfw::Cfg::APP_BASE_EID;
   static const int EXTBL_BASE_EID             = (OSK_CPP_DEMO_APP_BASE_EID + 10);
   static const int EX_APP_OBJ_BASE_EID        = (OSK_CPP_DEMO_APP_BASE_EID + 20);
