...
** $Id: $
**
** Title: Simulator (SIM) Application Command Utility Function
**        Header File
**
** Purpose: Specification for the CFS Simulator command utility
**          functions.
**
...
#ifndef _sim_cmd_utils_h_
#define _sim_cmd_utils_h_
...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/*                                                                 */
/* SIM command handler utility function prototypes                 */
/*                                                                 */
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
**/
boolean SIM_IsValidCmdPktLength(CFE_SB_MsgPtr_t CmdPacket, uint16 ExpectedLength, uint32 EventID, char *CmdText);


#endif /* _sim_cmd_utils_h_ */
