...
message_box("Instrument not in READY state",false)  unless (tlm("PL_SIM HK_TLM_PKT PAYLOAD_POWER") == "READY")
message_box("Instrument fault present",false)       unless (tlm("PL_SIM HK_TLM_PKT DETECTOR_FAULT") == "FALSE")
