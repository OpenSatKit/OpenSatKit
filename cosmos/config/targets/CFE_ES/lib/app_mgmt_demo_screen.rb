...
AMD_INSTRUCT_4 = ["This step starts the #{AMD_LOAD_APP} app. Notice the Registered app",
                  "count increments by one after the app is started.",
                  "",
...
def app_mgmt_demo(screen, button)
   ...
   if (button == "INFO")
      ...
      display("CFE_ES APP_MGMT_DEMO_INFO_SCREEN",500,50)    
      ...
      case $amd_step
         ...
         when 2..AMD_LAST_STEP
            ...
            clear("CFE_ES APP_MGMT_DEMO_SCREEN")
            clear("CFE_ES APP_MGMT_DEMO_INFO_SCREEN")
      end # Step Case
