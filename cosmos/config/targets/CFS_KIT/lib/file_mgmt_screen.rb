...
def file_mgmt_send_cmd(screen, cmd)
   ...
   if (cmd == "GET_FILE")
      ...
      flt_dir_name = ask_string("Enter full path of flight directory to be listed.")
      ...
      display("FM FILE_INFO_PKT",1500,50)
      Osk::flight.fm.send_cmd("GET_FILE_INFO with #{file_name}, FILEINFOCRC 2")  
