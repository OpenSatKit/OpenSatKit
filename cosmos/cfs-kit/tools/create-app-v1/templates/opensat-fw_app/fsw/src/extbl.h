...
**
*/
typedef boolean (*EXTBL_LoadTblFunc) (EXTBL_Struct* NewTbl);

/******************************************************************************
** Table owner callback: Load a single table entry
**
*/
typedef boolean (*EXTBL_LoadTblEntryFunc) (uint16 EntryId, EXTBL_Entry* TblEntry);

/******************************************************************************
** Table owner callback: Get pointer to table owner's data
**
*/
typedef EXTBL_Struct* (*EXTBL_GetDataPtrFunc) (void);
