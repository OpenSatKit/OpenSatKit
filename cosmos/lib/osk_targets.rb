...
#      that during OSK intialization. This file defines functions that 
...
def self.create_json_table_mgmt_scr(app_list)
   ...
   #
   # Notes:
   #   1. Do not edit this file directly. This file is automatically generated by
   #      osk_targets.rb so that is were edits should be made.
   #
   # License:
   #   Written by David McComas, licensed under the copyleft GNU General Public
   #   License (GPL).
