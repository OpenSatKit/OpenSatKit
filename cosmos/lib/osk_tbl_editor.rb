  ...
  class OskTblEditor < QtTool
    ...
    def update_title
      if @tab_book.currentTab.filename.empty?
        self.setWindowTitle("OSK JSON Table Editor : #{UNTITLED}")
      else
        self.setWindowTitle("OSK JSON Table Editor : #{@tab_book.currentTab.filename}")
      end
    ...
    def create_tab(filename = '')
      ...
      config_editor_frame = OskTblEditorFrame.new(self)
