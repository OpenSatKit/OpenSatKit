...
**
** Purpose:
**   Provide functions for the @TEMPLATE@ application used in cFE training.
**
*******************************************************************************/
...
int32 @TEMPLATE@_AppInit(void)
{
    ...
    */
    ...
    @TEMPLATE@_AppData.EventFilters[0].EventID = @TEMPLATE@_RESET_INF_EID;
    @TEMPLATE@_AppData.EventFilters[0].Mask    = CFE_EVS_NO_FILTER;
    
    @TEMPLATE@_AppData.EventFilters[1].EventID = @TEMPLATE@_CC1_ERR_EID;
    @TEMPLATE@_AppData.EventFilters[1].Mask    = CFE_EVS_EVERY_OTHER_TWO;
    
    @TEMPLATE@_AppData.EventFilters[2].EventID = @TEMPLATE@_LEN_ERR_EID;
    @TEMPLATE@_AppData.EventFilters[2].Mask    = CFE_EVS_FIRST_8_STOP;

    //Ex#1 @TEMPLATE@_AppData.EventFilters[3].EventID = @TEMPLATE@_NEW_CMD_INF_EID;
    //Ex#1 @TEMPLATE@_AppData.EventFilters[3].Mask    = CFE_EVS_EVERY_FOURTH_ONE;
